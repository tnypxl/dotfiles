...
@/Users/arikj/.config/opencode/get-shit-done/references/git-integration.md
</required_reading>
...
```bash
INIT=$(node /Users/arikj/.config/opencode/get-shit-done/bin/gsd-tools.js init execute-phase "${PHASE}" --include state,config)
```
...
See `/Users/arikj/.config/opencode/get-shit-done/references/tdd.md` for structure.
</tdd_plan_execution>
...
See /Users/arikj/.config/opencode/get-shit-done/references/checkpoints.md for details.
</step>
...
If user_setup exists: create `{phase}-USER-SETUP.md` using template `/Users/arikj/.config/opencode/get-shit-done/templates/user-setup.md`. Per service: env vars table, account setup checklist, dashboard config, local dev notes, verification commands. Status "Incomplete". Set `USER_SETUP_CREATED=true`. If empty/missing: skip.
</step>

<step name="create_summary">
Create `{phase}-{plan}-SUMMARY.md` at `.planning/phases/XX-name/`. Use `/Users/arikj/.config/opencode/get-shit-done/templates/summary.md`.
...
node /Users/arikj/.config/opencode/get-shit-done/bin/gsd-tools.js state advance-plan

# Recalculate progress bar from disk state
node /Users/arikj/.config/opencode/get-shit-done/bin/gsd-tools.js state update-progress

# Record execution metrics
node /Users/arikj/.config/opencode/get-shit-done/bin/gsd-tools.js state record-metric \
...
node /Users/arikj/.config/opencode/get-shit-done/bin/gsd-tools.js state add-decision \
  --phase "${PHASE}" --summary "${DECISION_TEXT}" --rationale "${RATIONALE}"

# Add blockers if any found
node /Users/arikj/.config/opencode/get-shit-done/bin/gsd-tools.js state add-blocker "Blocker description"
```
</step>
...
```bash
node /Users/arikj/.config/opencode/get-shit-done/bin/gsd-tools.js state record-session \
...
```bash
node /Users/arikj/.config/opencode/get-shit-done/bin/gsd-tools.js commit "docs({phase}-{plan}): complete [plan-name] plan" --files .planning/phases/XX-name/{phase}-{plan}-SUMMARY.md .planning/STATE.md .planning/ROADMAP.md
```
</step>
...
```bash
node /Users/arikj/.config/opencode/get-shit-done/bin/gsd-tools.js commit "" --files .planning/codebase/*.md --amend
```
</step>
