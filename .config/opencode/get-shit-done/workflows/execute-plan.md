...
See /Users/arikj/.config/opencode/get-shit-done/references/checkpoints.md for complete checkpoint guidance.
</step>
...
Create `.planning/phases/XX-name/{phase}-USER-SETUP.md` using template from `/Users/arikj/.config/opencode/get-shit-done/templates/user-setup.md`.
...
Use /Users/arikj/.config/opencode/get-shit-done/templates/summary.md for structure.
