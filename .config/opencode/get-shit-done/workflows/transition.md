...
```bash
TRANSITION=$(node /Users/arik/.config/opencode/get-shit-done/bin/gsd-tools.cjs phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node /Users/arik/.config/opencode/get-shit-done/bin/gsd-tools.cjs progress bar --raw)
```
...
```bash
node /Users/arik/.config/opencode/get-shit-done/bin/gsd-tools.cjs config-set workflow.auto_advance false
```
