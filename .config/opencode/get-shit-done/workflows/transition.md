...
```bash
TRANSITION=$(node /Users/arikj/.config/opencode/get-shit-done/bin/gsd-tools.js phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node /Users/arikj/.config/opencode/get-shit-done/bin/gsd-tools.js progress bar --raw)
```
